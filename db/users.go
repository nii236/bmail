...
type User struct {
	...
	BitmessageID string `db:"bitmessage_id" boil:"bitmessage_id" json:"bitmessage_id" toml:"bitmessage_id" yaml:"bitmessage_id"`
	Archived     string `db:"archived" boil:"archived" json:"archived" toml:"archived" yaml:"archived"`
	CreatedOn    string `db:"created_on" boil:"created_on" json:"created_on" toml:"created_on" yaml:"created_on"`
...
var UserWhere = struct {
	...
	BitmessageID whereHelperstring
	Archived     whereHelperstring
	CreatedOn    whereHelperstring
}{
	ID:           whereHelperint64{field: `id`},
	Username:     whereHelperstring{field: `username`},
	BitmessageID: whereHelperstring{field: `bitmessage_id`},
	Archived:     whereHelperstring{field: `archived`},
	CreatedOn:    whereHelperstring{field: `created_on`},
}
...
var (
	userColumns               = []string{"id", "username", "bitmessage_id", "archived", "created_on"}
	userColumnsWithoutDefault = []string{"username", "bitmessage_id"}
	userColumnsWithDefault    = []string{"id", "archived", "created_on"}
